...
namespace GeoStream.Api.Application.Interfaces.Services
{
    public interface IRouteService
    {
        ...
        Task<ResponseDto<IEnumerable<ResponseRouteDto>>> GetAllAsync(QueryRequestDto? requestDto);
        ...
        Task<ResponseDto<IEnumerable<ResponseRouteHubDto>>> GetAllRouteHubsAsync(QueryRequestDto? requestDto);
    }
}